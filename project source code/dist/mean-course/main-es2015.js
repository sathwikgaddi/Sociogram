...
let AuthService = class AuthService {
    ...
    createUser(email1, password1, username1) {
        const authData = { email: email1, password: password1, username: username1 };
    ...
    login(email1, password1) {
        const authData = { email: email1, password: password1 };
        this.http
...
module.exports = __webpack_require__(/*! D:\mean\mean-course\src\main.ts */"./src/main.ts");
